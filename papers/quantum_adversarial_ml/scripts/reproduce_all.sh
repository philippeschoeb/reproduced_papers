...
echo "================================================"
echo ""
echo "Results saved in $PAPER_DIR/outdir/"
echo ""
echo "Paper reproduction (Lu et al. 2020):"
echo "  - outdir/train_quantum/       : Amplitude-encoded classifier"
echo "  - outdir/attack_bim_eps*/     : BIM attack results"
echo "  - outdir/noise_comparison/    : Noise vs adversarial (Fig 11)"
echo "  - outdir/transfer_attacks/    : Black-box transfer (Table III)"
echo "  - outdir/defense/             : Adversarial training (Fig 16)"
echo "  - outdir/topological/         : Topological phases (Sec III.C)"
echo ""
echo "Extended analysis:"
echo "  - outdir/train_angle/         : Angle-encoded classifier"
echo "  - outdir/attack_angle_eps*/   : Attacks on angle-encoded model"
echo "  - outdir/noise_angle/         : Noise comparison for angle encoding"
echo ""
