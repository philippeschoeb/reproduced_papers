...
| [Quantum Convolutional Neural Networks](papers/QCNN_data_classification/). Source [hur_2022](http://arxiv.org/abs/2108.00661) | The source paper reports that under similar training budgets, the QCNN outperforms the CNN. The results were reproduced on a photonic architecture, however in such architecture, we conclude that classical models remain more parameter-efficient, but they cap out in absolute accuracy. |
